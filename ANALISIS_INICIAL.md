 ...
 **Rol 1 - Cliente:**
- **Descripción del rol:** Usuario final que accede al sistema (generalmente desde su celular) para consultar disponibilidad, reservar, reprogramar o cancelar turnos, y recibir notificaciones automáticas con los recordatorios de sus citas.
**Rol 2: Staff /personal de Barberia):**
**Descripción del rol:** personal operativo encargado de prestar los servicios. Utiliza el sistema para visualizar su agenda diaria de trabajo, consultar los servicios contratados por cada cliente y registrar la concreción de los turnos para el cálculo de sus comisiones.
**Rol 3: Administrador o Dueño:**
**Descripción del rol:** Usuario con acceso total a la gestión del negocio. Se encarga de configurar la oferta comercial (servicios, precios y duraciones), gestionar los perfiles del staff (horarios de trabajo, descansos y porcentajes de comisión), administrar la agenda general y consultar reportes e historial de turnos.
